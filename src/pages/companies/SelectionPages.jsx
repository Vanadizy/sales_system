...
export function CompanySetup() {
  ...
  const navigate = useNavigate()
  const [form, setForm] = useState({ name: '', businessType: 'Retail / General Merchandise', phone: '', email: account?.email || '', address: '', country: 'Tanzania', currency: 'TZS', tin: '', website: '', receiptFooter: 'Thank you for your business.', logo: '' })
  if (isSystemAdmin) return <Navigate to="/system-admin" replace />
